...
exports.classedFn   = function (names, b, selection)     {
    return selection.classed(names, b); }

exports.classedFnP  = function (names, fn, selection)    {
    return selection.classed(names, fn); }

exports.emptyFn     = function (selection)               {
    return selection.empty(); }

exports.enterFn     = function (selection)               {
    console.log("enter elements from here on using data already bound");
    return selection.enter(); }

exports.exitFn      = function (selection)               {
    return selection.exit(); }

exports.filterFn    = function (selector, selection)     {
    return selection.filter(selector); }

exports.filterFnP   = function (predicate, selection)    {
    return selection.filter(predicate); }

exports.getAttrFn   = function (attr, selection)         {
...
exports.nodesFn     = function (selection)               {
    return selection.nodes(); }

exports.orderFn     = function (selection)               {
...
exports.textFn      = function (text, selection)         {
